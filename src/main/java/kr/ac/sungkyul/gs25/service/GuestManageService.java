...
import kr.ac.sungkyul.gs25.dao.GuestManageDao;
...
public class GuestManageService {
	...
	public Map<String, Object> getGuestbookList(String spage, String keyword, Long store_no) {
		...
		System.out.println("번호 :"+store_no);
		// 이벤트 리스트 받기
		List<GuestbookVo> list = guestmanageDao.getGuestbookList(page, LIST_PAGESIZE, keyword, store_no);
