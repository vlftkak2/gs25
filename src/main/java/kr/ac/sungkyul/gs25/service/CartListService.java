...
public class CartListService {
	...
	public Map<String, Object> list(Long page, Long user_no,Long store_no) {
		...
		// 2.
		long totalCount = cartlistDao.getCal(store_no,user_no); // 전체 게시물 갯수
	...
	//찜목록 총 개수
	public int getCount(Long store_no,Long user_no){
		int TotalCount=cartlistDao.getCal(store_no,user_no);
		return TotalCount;
	}
